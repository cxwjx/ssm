...
<script src="model/js/amcharts.js"></script>	
<script src="model/js/serial.js"></script>	
<script src="model/js/light.js"></script>	
<script src="model/js/radar.js"></script>	
<link href="model/css/barChart.css" rel='stylesheet' type='text/css' />
<link href="model/css/fabochart.css" rel='stylesheet' type='text/css' />
<!--clock init-->
<script src="model/js/css3clock.js"></script>
<!--Easy Pie Chart-->
<!--skycons-icons-->
<script src="model/js/skycons.js"></script>

<script src="model/js/jquery.easydropdown.js"></script>
...
<!--js -->
<link rel="stylesheet" href="model/css/vroom.css">
<script type="text/javascript" src="model/js/vroom.js"></script>
<script type="text/javascript" src="model/js/TweenLite.min.js"></script>
<script type="text/javascript" src="model/js/CSSPlugin.min.js"></script>
